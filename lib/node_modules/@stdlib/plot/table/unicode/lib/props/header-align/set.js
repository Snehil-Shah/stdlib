...
/**
* Sets the alignment(s) of data within table header cells.
*
* @private
* @param {(Array<string>|string|null)} value - cell alignment(s)
...
function set( value ) {
	...
	if ( isString( value ) ) {
		if ( !isAlignment( value ) ) {
			throw new TypeError( format( 'invalid assignment. `%s` must be a supported alignment. Value: `%s`.', 'headerAlign', value ) );
		}
		value = [ value ];
