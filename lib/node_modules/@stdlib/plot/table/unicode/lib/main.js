...
* @param {(NonNegativeIntegerArray|NonNegativeInteger)} [options.maxColumnWidth] - maximum cell width(s)
...
/**
* Maximum column width(s) in units of grapheme clusters (i.e., visual characters).
*
* @name maxColumnWidth
* @memberof UnicodeTable.prototype
